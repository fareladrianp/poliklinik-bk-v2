        ...
        <div class="flex-1 flex flex-col ml-64">
            ...
            <main class="flex-1 container mx-auto px-6 py-6">
                <div class="bg-white rounded shadow p-6">
                    <h3 class="text-2xl font-bold mb-4">Kelola Data Dokter</h3>
                    <p class="text-xl mb-4">Tambah Data Dokter</p>
                    <form action="{{ route('tambah.dokter') }}" method="post" class="mb-4">
                        @csrf
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            ...
                            <div>
                                <label for="id_poli" class="form-label block mb-2 text-sm font-medium text-black">Poli</label>
                                    <select class="form-control bg-slate-300 rounded-md block w-full p-2.5" name="id_poli">
                    ...
                    <p class="text-xl mb-4">Daftar Dokter</p>
                    <table class="border border-slate-500">
                        <thead>
                          <tr>
                            ...
                            <th class="border border-slate-600 py-2 px-24">Poli</th>
                        ...
                        <tr>
                            ...
                            <td class="border border-slate-600 py-1 text-center">{{ $data->poli->nama_poli }}</td>
                                ...
                                <div id="edit-modal-{{ $data->id }}" tabindex="-1" aria-hidden="true" 
                                    ...
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        <div class="bg-white rounded-lg shadow dark:bg-gray-400">
                                            ...
                                            <!-- Modal Body -->
                                            <form action="{{ route('update.dokter', $data->id) }}" method="post" class="p-4" >
                                                @csrf
                                                <div class="mb-4">
                                                ...
                                                <div class="mb-4">
                                                    <label class="block text-sm font-medium text-gray-700">Poli</label>
                                                        <select class="form-control" id="id_poli" name="id_poli" required>
                                                            <option value="" disabled selected>Pilih Poli</option>
                                                            @foreach ($poli as $dpoli)
                                                            <option value="{{ $dpoli->id }}" {{ old('id_poli') == $dpoli->id ? 'selected' : '' }}>
                                                                {{ $dpoli->nama_poli }}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                    ...
                                    <form action="{{ route('delete.dokter', $data->id) }}" method="post">
                                        @csrf
