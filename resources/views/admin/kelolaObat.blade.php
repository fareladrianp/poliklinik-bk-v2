        ...
        <div class="flex-1 flex flex-col ml-64">
            ...
            <main class="flex-1 container mx-auto px-6 py-6">
                <div class="bg-white rounded shadow p-6">
                    <h3 class="text-2xl font-bold mb-4">Kelola Data Obat</h3>
                    <p class="text-xl mb-4">Tambah Data Obat</p>
                    <form action="{{ route('tambah.obat') }}" method="post" class="mb-4">
                        @csrf
                        
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            <div>
                                <label for="first_name" class="block mb-2 text-sm font-medium text-black">Nama Obat</label>
                                <input type="text" name="nama_obat" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                            </div>
                            <div>
                                <label for="last_name" class="block mb-2 text-sm font-medium text-black">Kemasan</label>
                                <input type="text" name="kemasan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                            </div>
                            <div>
                                <label for="company" class="block mb-2 text-sm font-medium text-black">Harga</label>
                    ...
                    <p class="text-xl mb-4">Daftar Obat</p>
                    <table class="border border-slate-500">
                        <thead>
                          <tr>
                            <th class="border border-slate-600 py-2 px-2">No.</th>
                            <th class="border border-slate-600 py-2 px-24">Nama Obat</th>
                            <th class="border border-slate-600 py-2 px-24">Kemasan</th>
                            <th class="border border-slate-600 py-2 px-24">Harga</th>
                            <th class="border border-slate-600 py-2 px-24">A</th>
                          </tr>
                        </thead>
                        <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border border-slate-600 py-1 text-center">{{ $data->nama_obat }}</td>
                            <td class="border border-slate-600 py-1 text-center">{{ $data->kemasan }}</td>
                            <td class="border border-slate-600 py-1 text-center">{{ number_format($data->harga, 0, ',', '.') }}</td>
                            <td class="border border-slate-600 py-1 text-center">
                                ...
                                <div id="edit-modal-{{ $data->id }}" tabindex="-1" aria-hidden="true" 
                                    ...
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        <div class="bg-white rounded-lg shadow dark:bg-gray-400">
                                            ...
                                            <div class="flex items-center justify-between p-4 border-b dark:border-gray-600">
                                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Edit Data Obat</h3>
                                            ...
                                            <!-- Modal Body -->
                                            <form action="{{ route('update.obat', $data->id) }}" method="post" class="p-4" >
                                                @csrf
                                                <div class="mb-4">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" name="kemasan" value="{{ $data->kemasan }}" 
                                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 pl-2">
                                                </div>
                                                <div class="mb-4">
                                    ...
                                    <form action="{{ route('delete.obat',  $data->id ) }}" method="post">
                                        @csrf
